      ...
      <div className="w-full flex">
        ...
        <div className="content ml-[10%] text-white flex flex-col gap-2">
            <h1 className="font-black text-4xl">
                ...
                <small className="text-xl font-semibold items-center ml-2 text-zinc-300">({info.detail.release_date.split("-")[0]})</small>
            </h1>
            ...
            <h1 className="text-xl font-bold">Movie Translated</h1>
